...
plugin.t3sbootstrap_configuration {
	general {
		...
		onePage.variant = 1
		# cat=t3sbootstrap/a-general/50; type=boolean; label=Wrapper section height: Background- and Parallax-wrapper min-height = 100% of the viewport height if active
		wrapper.minVh = 1
		# cat=t3sbootstrap/a-general/60; type=boolean; label=Body padding auto: set by JS if .navbar-fixed-top or .sticky-footer
		bodyPadding.auto = 1
	}
	pages {
	...
	navigation {
		...
		navbar.hover = 0
		# cat=t3sbootstrap/c-navigation/082; type=boolean; label=Bootstrap Sub-Menus: enable "Bootstrap-submenu" for submenus on mobile view - Info: https://vsn4ik.github.io/bootstrap-submenu/
		navbar.submenu = 0
	...
	# (boolean) search icon in navBar will link direct to the "indexed_search target page", if enabled.
