	...
	10 {
		...
		1 {
			...
			IFSUB {
				...
				ATagParams = class="dropdown-toggle" data-toggle="dropdown" data-submenu="" aria-expanded="true"
				ATagBeforeWrap = 1
		...
		2 {
			...
			IFSUB.linkWrap = {register:glyphicon}{register:fontawesome} | <b class="caret"></b>
			ACTIFSUB < .IFSUB
...
#-------------------------------------------------------------------------------
#	NAVIGATION: Section Menu (one-page-layout)
#-------------------------------------------------------------------------------
lib.sectionMenu =< lib.fluidContent
lib.sectionMenu {
    templateName = OnePageMenuSection
    dataProcessing {
        10 = TYPO3\CMS\Frontend\DataProcessing\MenuProcessor
        10 {
            special = list
			special.data = page:uid
            dataProcessing {
